...
x.execute (" INSERT INTO result VALUES ('%s','%s','%s', '%s','%s','%s','%s')"%(datetime.datetime.utcnow(),'FPT','FPT_LIVETV', 20,livetv_fpt_use,20 - livetv_fpt_use, livetv_fpt_use/20*100,))
...
x.execute (" INSERT INTO result VALUES ('%s','%s','%s', '%s','%s','%s','%s')"%(datetime.datetime.utcnow(),'NPS','NPS_LIVETV', 30,livetv_nps_use,30 - livetv_nps_use, livetv_nps_use/30*100,))
...
x.execute (" INSERT INTO result VALUES ('%s','%s','%s', '%s','%s','%s','%s')"%(datetime.datetime.utcnow(),'NTL','NTL_LIVETV', 20,livetv_ntl_use,20 - livetv_ntl_use, livetv_ntl_use/20*100,))
...
x.execute (" INSERT INTO result VALUES ('%s','%s','%s', '%s','%s','%s','%s')"%(datetime.datetime.utcnow(),'HCM','HCM_LIVETV', 20,livetv_hcm_use,20 - livetv_hcm_use, livetv_hcm_use/20*100,))
...
x.execute (" INSERT INTO result VALUES ('%s','%s','%s', '%s','%s','%s','%s')"%(datetime.datetime.utcnow(),'NPS','NPS_CDN', 20,cdn_nps_use,20 - cdn_nps_use, cdn_nps_use/20*100,))
...
x.execute (" INSERT INTO result VALUES ('%s','%s','%s', '%s','%s','%s','%s')"%(datetime.datetime.utcnow(),'FPT','FPT_CDN', 20,cdn_fpt_use,20 - cdn_fpt_use, cdn_fpt_use/20*100,))
...
x.execute (" INSERT INTO result VALUES ('%s','%s','%s', '%s','%s','%s','%s')"%(datetime.datetime.utcnow(),'NTL','NTL_CDN', 20,cdn_ntl_use,20 - cdn_ntl_use, cdn_ntl_use/20*100,))
...
x.execute (" INSERT INTO result VALUES ('%s','%s','%s', '%s','%s','%s','%s')"%(datetime.datetime.utcnow(),'HCM','HCM_CDN', 20,cdn_hcm_use,20 - cdn_hcm_use, cdn_hcm_use/20*100,))
